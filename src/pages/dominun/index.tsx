  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const mobileFallback: any =
        'indent://com.dompixel.dominun/delivery/cuiaba-mt/serra-grande-a-casa-da-cerveja-morada-do-ouro/98873ec5-eb1f-4dff-840f-5c9fa40adf94#Intent;package=br.com.brainweb.ifood;scheme=https;end'
      const app: any =
